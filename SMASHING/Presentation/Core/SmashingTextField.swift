...
final class SmashingTextField: UITextField {
    ...
    func resetToDefault() {
        self.layer.borderColor = self.isFirstResponder ? UIColor.systemBlue.cgColor : UIColor.black.cgColor
